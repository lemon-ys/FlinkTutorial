...
object JdbcSinkTest {
  def main(args: Array[String]): Unit = {
    ...
    // 读取数据
    val inputPath = "E:\\FlinkProject\\src\\main\\resources\\sensor.txt"
...
class MyJdbcSinkFunc() extends RichSinkFunction[SensorReading]{
  ...
  override def open(parameters: Configuration): Unit = {
    conn = DriverManager.getConnection("jdbc:mysql://175.24.152.40:33190/ads", "yaoshun", "vp^98*s$UpTRsebf")
